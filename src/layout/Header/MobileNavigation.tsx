    ...
    <Popover>
      ...
      <Transition.Root>
        ...
        >
          <Popover.Panel
            as="div"
            className="absolute inset-x-0 top-full mt-4 flex origin-top flex-col rounded-2xl bg-main-bg p-4 text-lg tracking-tight text-main-text shadow-xl ring-1 ring-slate-900/5"
          >
